...
import org.phantomapi.inventory.PhantomInventoryWrapper;
import org.phantomapi.sync.I;

/**
 * Async inventory, only void methods are currently supported
 * 
 * @author cyberpwn
 */
public class AsyncInventory implements PhantomInventoryWrapper
{
	protected Inventory i;
	
	public AsyncInventory(Inventory i)
	{
		this.i = i;
	}
