...
public class EntityNBT extends EntityNBTBase
{
	static
	{
		...
		variables.add("ExplosionPower", new IntegerVariable("ExplosionPower", 0, 25)); // Limited
																						// to
																						// 25
		...
		variables.add("ExplosionRadius", new ByteVariable("ExplosionRadius", (byte) 0, (byte) 25)); // Limited
																									// to
																									// 25
