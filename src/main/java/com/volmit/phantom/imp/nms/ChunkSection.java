...
{
	/**
	 * The number of blocks in a chunk section, and thus the number of elements in
	 * all arrays used for it.
	 */
	public static final int ARRAY_SIZE = 16 * 16 * 16;
	/**
	 ...
	 */
	public static final byte EMPTY_SKYLIGHT = 15;
	/**
	 * The default value for block light, used on new chunk sections.
	 */
	public static final byte DEFAULT_BLOCK_LIGHT = 15;
	/**
	 * The default value for sky light, used on new chunk sections.
	 */
	public static final byte DEFAULT_SKYLIGHT = 15;
	/**
	 ...
	 * skylight.
	 *
	 * @return The sky light array. If the dimension of this chunk section's chunk's
	 *         world is not the overworld, this array contains only maximum light
	 *         levels.
	 */
	@Getter
	...
	/**
	 * The number of non-air blocks in this section, used to determine whether it is
	 * empty.
	 */
	private int count;
	 ...
	 *
	 * <p>
	 * This ChunkSection assumes ownership of the arrays passed in, and they should
	 * not be further modified.
	 * </p>
	 *
	 * @param types
	 *            An array of block state IDs for this chunk section (containing
	 *            type and metadata)
	 */
	 ...
	 *
	 * @param types
	 *            An array of block types for this chunk section.
	 * @param skyLight
	 *            An array for skylight data for this chunk section.
	 * @param blockLight
	 *            An array for blocklight data for this chunk section.
	 */
	 ...
	 *
	 * @param data
	 *            An array of blocks in this section.
	 * @param palette
	 ...
	 *
	 * @param types
	 *            An array of block IDs, with metadata
	 ...
	 *
	 * @param types
	 *            An array of block IDs, without metadata.
	 * @return A matching chunk section.
	 */
	 ...
	 *
	 * @param x
	 *            The x coordinate, for east and west.
	 * @param y
	 *            The y coordinate, for up and down.
	 * @param z
	 *            The z coordinate, for north and south.
	 * @return The index.
	 */
	 ...
	 * recounting non-air blocks.
	 * </p>
	 *
	 * <p>
	 * This is an expensive operation, but occasionally performing it will improve
	 * sending the section.
	 */
	...
	public void setType(int x, int y, int z, int id, byte value)
	{
		setType(x, y, z, (char) IDUtils.getCombined(id, value));
	}
	 ...
	 *            The z coordinate, for north and south.
	 * @param value
	 *            The new type ID for that coordinate.
	 */
	...
	/**
	 * <p>
	 * Checks whether this chunk section is empty, IE doesn't need to be sent or
	 * saved.
	 * </p>
	 *
	 * <p>
	 * This implementation has the same issue that causes
	 * <a href="https://bugs.mojang.com/browse/MC-80966">MC-80966</a>:
	 * </p>
	 *
	 * <p>
	 * It assumes that a chunk section with only air blocks has no meaningful data.
	 * This assumption is incorrect for sections near light sources, which can
	 * create lighting bugs. However, it is more expensive to send additional
	 * sections with just light data.
	 * </p>
	 *
	...
	public static void writeVarInt(ByteArrayOutputStream buf, int value)
	{
		int part;
		while(true)
		{
	...
	public static void writeLong(ByteArrayOutputStream boas, long v)
	{
