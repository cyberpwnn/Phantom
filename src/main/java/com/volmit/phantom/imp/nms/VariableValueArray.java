...
public final class VariableValueArray implements Cloneable
{
	 ...
	 *
	 * @param bitsPerValue
	 *            the number of bits into which each value must fit
	 * @param capacity
	...
	/**
	 * Creates a new VariableValueArray with the contents of this one, and the given
	 * bits per value.
	 *
	 ...
	 * @throws IllegalArgumentException
	 *             If newBitsPerValue is less than or equal to the current bits per
	 *             value. Setting it to the same size would be a waste of resources,
