...
import phantom.vfx.ParticleEffect.ParticleData;
import phantom.vfx.ReflectionUtils.PackageType;
...
public enum ParticleEffect
{
	...
	public void display(float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException
	{
		if(!isSupported())
		{
			PD.f("Particle Incompatible with this server version!");
			return;
		}
	...
	public static final class ParticlePacket
	{
		...
		public static void initialize() throws VersionIncompatibleException
		{
			...
			{
				PD.f("Particles incompatible with this server version!");
			}
